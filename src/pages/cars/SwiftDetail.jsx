// src/pages/cars/SwiftDetail.jsx
...
The Maruti Suzuki Swift is a stylish and efficient hatchback, 
renowned for its agile performance, modern features, 
and compact design. Ideal for both city commutes and weekend getaways.
`;
        ...
        <div className="flex flex-col items-start justify-center w-full px-4 space-y-6 lg:w-1/2 lg:px-0">
          ...
          <div className="grid w-full grid-cols-2 gap-4 mt-4">
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              ...
              <p className="text-xl font-bold">1.2L 4-Cylinder</p>
            </div>
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              <p className="text-sm font-medium text-gray-500">Horsepower</p>
              <p className="text-xl font-bold">83 HP</p>
            </div>
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              <p className="text-sm font-medium text-gray-500">0-100 km/h</p>
              <p className="text-xl font-bold">10.2s</p>
            </div>
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
