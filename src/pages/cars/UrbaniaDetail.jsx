...
The Ford Urbania is a versatile and spacious MPV designed to meet the needs of modern families. 
Combining comfort, space, and a powerful engine, it is ideal for both urban commuting and long journeys.
`;
  ...
  const handlePayment = () => {
    navigate('/payment', {
      state: {
        ...
        carImage: urbaniaImage,
      },
    });
  };

  return (
    <div className={`${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} min-h-screen w-screen flex flex-col items-center justify-center transition duration-500 p-6`}>
        ...
        <div className="flex flex-col items-start justify-center w-full px-4 space-y-6 lg:w-1/2 lg:px-0">
          ...
          <div className="grid w-full grid-cols-2 gap-4 mt-4">
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              ...
              <p className="text-xl font-bold">2.0L Turbocharged</p>
            </div>
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              <p className="text-sm font-medium text-gray-500">Horsepower</p>
              <p className="text-xl font-bold">200 HP</p>
            </div>
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
            ...
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md`}>
              ...
              <p className="text-xl font-bold">190 km/h</p>
            </div>
          </div>
