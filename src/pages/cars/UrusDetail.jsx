...
// Import the Urus image from assets
import urusImage from '../../assets/Urus.png';

const carDescription = `
The Lamborghini Urus is a high-performance luxury SUV that combines the soul of a supercar with the functionality of an SUV. 
With a 4.0L twin-turbo V8 engine producing 641 horsepower, it accelerates from 0-100 km/h in just 3.6 seconds.
The cutting-edge technology and luxurious interiors deliver a thrilling driving experience unlike any other SUV.
`;
...
const UrusDetail = () => {
  ...
  useEffect(() => {
    setTotalAmount(10000 * selectedDuration);
  }, [selectedDuration]);
  ...
  return (
    <div className={`${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} min-h-screen w-screen flex flex-col items-center justify-center transition-colors duration-500 p-6 overflow-hidden`}>
      
      {/* Background pattern */}
      <div className={`absolute inset-0 ${darkMode ? 'opacity-5' : 'opacity-10'} bg-[url('data:image/svg+xml;base64,')]`}></div>
        ...
        <div className="flex flex-col items-start justify-center w-full px-4 space-y-6 lg:w-1/2 lg:px-0">
          ...
          <div className={`p-6 rounded-xl w-full mt-4 ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
            <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-xl font-bold">₹10,000/Day</p>
            </div>
